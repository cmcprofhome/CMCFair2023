...
def create_retort(strict_coercion: bool, *args, **kwargs) -> Retort:
    # this function should probably be moved to the separate file / module, but for the sake of simplicity
    # of the template I'm keeping it here

    # add any extra arguments, schemas, validators, etc. to the Retort instance if you have to
